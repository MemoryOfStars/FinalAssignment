...
static void PWM_Set_Dutycycle( unsigned long dutycycle )
{
	unsigned long tcon;
	unsigned long tcnt;
	unsigned long tcfg1;
	...
	tcnt  = (pclk/50/16)/1500;//¹Ì¶¨ÆµÂÊÎª1500Hz
	
	__raw_writel(tcnt, S3C2410_TCNTB(0));
	__raw_writel(tcnt*dutycycle/100, S3C2410_TCMPB(0));
